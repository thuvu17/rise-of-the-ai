...
//    void update(float delta_time, Entity *player, Entity *objects,
...
//    
//    void const check_out_of_bound(float width, float height);
//    
//    float const x_distance_from_player(Entity *player) const;
//    
